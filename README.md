...
| streaming                     | Boolean | true    | Avoids buffering of ResultSet results to memory before returning the first row to caller. Buffering might still be activated if ResultSet processing requires more information from backend. |
